...
while not busted:
    ...
    print("essai avec d = " + str(d) + "\n" + str(nbRequetesTraite) + 
    " requetes traitees et " + str(nbRequetesLong) + " requetes ont pris plus de 0.5 secondes\n" +
    str(pourcentageGood) + "%\n\n========================================\n")
    dGraphe.append(d)
...
plt.plot(dGraphe, pourcentageGraphe)
plt.xlabel("temps de traitement d")
plt.ylabel("pourcentage de réussite")
plt.axhline(y=99.5, color='r', linestyle='-')
plt.grid()
plt.show()
